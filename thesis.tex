...
Lời đầu tiên, em xin dành lời cảm ơn chân thành đến  TS.Hoàng Thị Điệp. Trong quá trình làm khóa luận em đã nhận được sự hướng dẫn nhiệt tình và chu đáo từ cô. Những lời khuyên và kiến thức được truyền đạt đóng góp rất lớn trong khóa luận của em. Cô cũng rất hỗ trợ em trong quá trình định hướng cũng như chỉ ra những vấn đề thiếu sót của bản thân em để cho em ngày một hoàn thiện bản thân mình một cách tốt hơn.
...
\subsubsection{Nhánh others}
 ...
 \begin{figure}[h]
	\centering
	\includegraphics[scale=0.55]{Image/5.1.png}
	\caption{ Giao diện của ứng dụng GIQ-TREE }
	\label{fig:image5.1}
\end{figure}
